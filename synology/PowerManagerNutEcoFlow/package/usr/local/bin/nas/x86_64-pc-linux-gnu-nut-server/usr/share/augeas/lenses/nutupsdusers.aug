(*
Module: NutUpsdUsers
 Parses /home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upsd.users
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all users granted to send commands to UPS
      > /files/home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upsd.users/fred/actions/SET

About: Configuration files
  This lens applies to /home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upsd.users. See <filter>.
*)
...
let upsd_users_filter = ( incl "/home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upsd.users" )
			. Util.stdexcl
