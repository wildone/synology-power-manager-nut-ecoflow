(*
Module: NutUpsdConf
 Parses /home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upsd.conf
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all network interface upsd will listen to
      > print /files/home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upsd.conf/LISTEN

About: Configuration files
  This lens applies to /home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upsd.conf. See <filter>.
...
let upsd_filter = (incl "/home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upsd.conf")
		. Util.stdexcl
