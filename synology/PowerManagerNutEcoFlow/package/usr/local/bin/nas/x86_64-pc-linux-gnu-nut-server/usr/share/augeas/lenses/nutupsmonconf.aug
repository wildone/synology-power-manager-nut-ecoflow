...
Module: NutUpsmonConf
 Parses /home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upsmon.conf
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all notification messages
      > print /files/home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upsmon.conf/NOTIFYMSG

About: Configuration files
  This lens applies to /home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upsmon.conf. See <filter>.
*)
...
let upsmon_filter = ( incl "/home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upsmon.conf" )
			. Util.stdexcl
