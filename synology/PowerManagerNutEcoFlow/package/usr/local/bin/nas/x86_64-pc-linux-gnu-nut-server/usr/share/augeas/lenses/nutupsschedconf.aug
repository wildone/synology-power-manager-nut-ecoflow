...
Module: NutUpsSchedConf
 Parses /home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upssched.conf
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print the command script:
      > print /files/home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upssched.conf/CMDSCRIPT

About: Configuration files
  This lens applies to /home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upssched.conf. See <filter>.
*)
...
let upssched_filter = ( incl "/home/efsz/proj/ps-003/ef-nut/x86_64-pc-linux-gnu-nut-server/etc/upssched.conf" )
			. Util.stdexcl
